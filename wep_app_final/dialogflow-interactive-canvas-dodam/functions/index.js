...
app.intent('welcome', (conv) => {
  if (!conv.surface.capabilities
   ...
   conv.ask('<speak>' +
    '<audio src="https://firebasestorage.googleapis.com/v0/b/canvas-80463.appspot.com/o/res%2FSplashing_Around.mp3?alt=media&token=c98b47a2-f58c-4dac-98fb-16b2b2a95b7c">text</audio>' +
    '</speak>');
  conv.ask('hi! Do you want me to change color or pause spinning? ' +
